...
const Sponsors: React.FC = () => {
  ...
  const sponsors = [
    { name: "BiE - Beauty in Everything", tier: "platinum", img: "/images/sponsors/bie.png" },
    { name: "The Beaded Babe", tier: "platinum", img: "/images/sponsors/beaded.png" },
    { name: "SOE - Building Future", tier: "gold", img: "/images/sponsors/soe.png" },
    { name: "Satyam Collection", tier: "silver", img: "/images/sponsors/satyam.png" },
    { name: "DoughY", tier: "silver", img: "/images/sponsors/doughy.png" },
    { name: "Wrapping & Co.", tier: "silver", img: "/images/sponsors/wrapping.png" },
    { name: "MAAC - Maya Academy of Advanced Cinematics", tier: "silver", img: "/images/sponsors/maac.png" },
    { name: "CreatED", tier: "silver", img: "/images/sponsors/created.png" },
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ companyName: '', contactEmail: '', phoneNumber: '', tier: 'Select Sponsorship Tier', img: '' });
          ...
          {sponsors.map((sponsor, idx) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="w-20 h-20 mx-auto mb-6 rounded-full overflow-hidden flex items-center justify-center bg-black/30 border border-white/10 shadow-inner">
                  <img
                    src={sponsor.img}
                    alt={sponsor.name}
                ...
                <span className={`inline-block px-4 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase border ${sponsor.tier === 'platinum'
