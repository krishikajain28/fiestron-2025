...
const Archives: React.FC<ArchivesProps> = ({ items, onBack }) => {
  const [selectedIndex, setSelectedIndex] = useState<number | null>(null);
  
  // --- Mouse Tracking for that "Premium Smoothness" (But NO GRID) ---
  ...
  return (
    <div 
      ...
      className="min-h-screen w-full bg-[#050505] text-white overflow-hidden relative" // Exact match to Gallery BG
    >
        
        {/* --- PREMIUM RIPPLE (No Grid, just lighting) --- */}
        <div 
      ...
      >
        ...
        {/* --- CLEAN GRID (No text outside images) --- */}
      ...
      {/* --- LIGHTBOX (Dismissible by background click) --- */}
      <AnimatePresence>
        {selectedIndex !== null && activeItem && (
            ...
            >
                ...
                <div className="relative w-full h-full max-w-5xl flex flex-col items-center justify-center p-6 md:p-12 pointer-events-none">
                    ...
                    {/* Text - Clicking text does NOT close */}
                    <motion.div 
