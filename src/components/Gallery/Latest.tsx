...
const Latest: React.FC<LatestProps> = ({ onBack }) => {
  return (
    <motion.div
      key="latest"
    ...
    >
        ...
        <h2 className="text-3xl font-bold text-white mb-2">Latest Edition</h2>
        <p className="text-white/40 max-w-md">
            We are currently curating the visual memories for the latest Fiestron event. Check back shortly!
        </p>
    </motion.div>
  );
};
